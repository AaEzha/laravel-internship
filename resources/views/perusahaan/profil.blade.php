        ...
        <div class="col-lg-4 order-lg-2">
            ...
            <div class="card shadow mb-4">
                <div class="card-profile-image mt-4">
                    <figure class="rounded-circle avatar avatar font-weight-bold" style="font-size: 60px; height: 180px; width: 180px;" data-initial="{{ $data->name[0].$data->name[-1] }}"></figure>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-8 order-lg-1">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('perusahaan.profil_store') }}" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="name" class="form-control" name="name" placeholder="Name" value="{{ old('name', $data->name) }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="address" class="form-control" name="address" placeholder="Address" value="{{ old('address', $data->address) }}">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="phone">Phone<span class="small text-danger">*</span></label>
                                        <input type="text" id="phone" class="form-control" name="phone" placeholder="Phone number" value="{{ old('phone', $data->phone) }}">
                                    </div>
                                </div>
                            </div>
                        </div>
